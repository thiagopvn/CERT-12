...
const emailUser = defineString('EMAIL_USER', { default: 'certidao.12gbm@gmail.com' });
...
const getTransporter = () => {
  return nodemailer.createTransport({
    ...
    auth: {
      ...
      pass: process.env.EMAIL_PASS || "lhnjmsuzwsiasazj", // Fallback para desenvolvimento local
    },
  });
};
...
exports.testarEmail = onCall({
  ...
  const mailOptions = {
    from: '"Sistema de Certidões" <certidao.12gbm@gmail.com>',
...
exports.enviarEmailCertidaoV2 = onCall({
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        <div style="text-align: center; margin-bottom: 20px;">
          <img src="cid:LOGO12GBM" alt="12ºGBM" style="max-width: 150px; height: auto;" />
        </div>
        ...
        <p>Atenciosamente,</p>
        <p><strong>12º GBM - Jacarepaguá</strong></p>
    ...
    attachments: [
      {
        filename: 'LOGO12GBM.png',
        path: './LOGO12GBM.png', // Caminho relativo ao arquivo na pasta functions
        cid: 'LOGO12GBM' // ID referenciado no src da imagem
      }
    ]
  };
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <div style="background-color: #2c3e50; color: white; padding: 20px; text-align: center;">
                  <h1 style="margin: 0;">Sistema de Certidões - 12ºGBM</h1>
                </div>
                ...
                <div style="background-color: #2c3e50; color: white; padding: 15px; text-align: center; font-size: 12px;">
                  <p style="margin: 5px 0;">12º GBM - Jacarepaguá</p>
  ...
  try {
    ...
    const envioPromises = ocorrenciasConcluidas.map(async (ocorrencia) => {
      try {
        ...
        const urlPesquisa = `https://certidao-12gbm.web.app/feedback?id=${ocorrencia.id}`;
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9f9f9; color: #333333;">
              ...
              <div style="padding: 30px; background-color: white; border-left: 1px solid #e1e1e1; border-right: 1px solid #e1e1e1;">
                ...
                <p style="margin-top: 0; font-size: 16px;"><strong>12º GBM - Jacarepaguá</strong></p>
              </div>
              ...
              <div style="background-color: #f5f5f5; padding: 20px; text-align: center; border-radius: 0 0 8px 8px; border: 1px solid #e1e1e1; border-top: none;">
                <img src="cid:LOGO12GBM" alt="12ºGBM" style="max-width: 120px; height: auto; margin-bottom: 15px;" />
